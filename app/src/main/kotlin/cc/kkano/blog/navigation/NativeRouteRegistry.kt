...
object NativeRouteRegistry {
    val features: List<FeatureSpec> = listOf(
        ...
        FeatureSpec("pages/user/footprint-manage", "足迹管理", "管理", ApiRoutes.FOOTPRINT_MANAGE, FeatureMode.LIST, "足迹列表"),
        ...
        FeatureSpec("pages/user/usercomments", "我的评论", "账户", ApiRoutes.COMMENTS, FeatureMode.LIST, "评论列表"),
