...
object NativeRouteRegistry {
    val features: List<FeatureSpec> = listOf(
        ...
        FeatureSpec("pages/user/local-library", "本地资源库", "账户", mode = FeatureMode.LOCAL_SETTINGS, description = "本地壁纸、视频目录与资源统计"),
        ...
        FeatureSpec("pages/contents/imagetoday", "图库", "内容", ApiRoutes.MEDIA, FeatureMode.LIST, "三栏媒体图库"),
        ...
        FeatureSpec("pages/contents/myWallpaper", "媒体图片", "内容", ApiRoutes.MEDIA, FeatureMode.LIST, "三栏媒体图库"),
